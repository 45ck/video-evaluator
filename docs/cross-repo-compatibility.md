...
Older or product-specific artifacts can still exist beside these files. The
canonical analyzer files are the compatibility layer that `content-machine`,
`demo-machine`, and future repos should consume first.
